        ...
        <Card :bordered="false">
            ...
            <Form ref="formItem" :model="formItem" :rules="ruleValidate" :label-width="80">
                ...
                <FormItem label="地址" prop="src">
                    ...
                    <p class="desc">支持上传的文件格式为 mp4 且文件大小不超过 {{file_size}} M</p>
                    <Upload
                            ref="upload"
                    ...
                    <Button style="margin-left: 100px;margin-top: -68px;" @click="viewVideo(formItem.src)">查看视频</Button>
                </FormItem>
  ...
  export default {
    ...
    methods: {
      viewVideo (src) {
        ...
        const title = '查看视频';
        const content = '<video style="width:88%;" id="video" autoplay="autoplay" src="'+ src +'"></video>';
        this.$Modal.info({
          title: title,
          content: content
        });
